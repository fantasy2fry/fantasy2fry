...
- [Serverless EduRAG](https://github.com/annaostrowska03/serverless-edurag) - This project implements a scalable serverless Retrieval-Augmented Generation system on Google Cloud Platform, combining asynchronous document ingestion and vectorization with real-time semantic retrieval and AI-powered question answering using Vertex AI.
- [Cats Image Generation](https://github.com/fantasy2fry/cats-image-generation) - This project explores generative deep learning for cat image synthesis by implementing and comparing DCGAN, DDPM, and β-VAE architectures, alongside experiments with image preprocessing, data augmentation, hyperparameter tuning, and latent space interpolation.
